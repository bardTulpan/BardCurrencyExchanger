...
//    public ResponseEntity<ApiResponse<?>> handleCurrencyNotFound(ExchangeNotFoundException ex, HttpServletRequest request) {
...
//    public ResponseEntity<ApiResponse<?>> handleCurrencyAlreadyExists(ExchangeAlreadyExistsException ex, HttpServletRequest request) {
//        ApiResponse<?> response = ApiResponse.error(ex.getMessage(), ex.getErrorCode());
//        return ResponseEntity.status(ex.getHttpStatus()).body(response);
//    }
//
//    @ExceptionHandler(DatabaseException.class)
//    public ResponseEntity<ApiResponse<?>> handleDatabaseException(DatabaseException ex, HttpServletRequest request) {
//        ApiResponse<?> response = ApiResponse.error(ex.getMessage(), ex.getErrorCode());
//        return ResponseEntity.status(ex.getHttpStatus()).body(response);
//    }
//
